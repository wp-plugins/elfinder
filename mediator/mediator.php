...
function elfinder_mount_settings(){
	...
	<span class="description"><?php _e('Divided by commas &mdash here and below.', 'elfinder'); ?></span></td>
	</tr>
	...
	<tr valign="top">
	<th scope="row"><?php _e('File modification date format', 'elfinder' ); ?></th> 
	...
	<?php } ?>
		...
		<em>/^user_dir\/.*/ + r w rm + <?php _e('«default access..» is set to «read» only &rarr; read &mdash all, write and delete only in personal directory', 'elfinder') ?></em>
	</div></td></tr>
